 ...
 * @date 2015年5月8日
 */
public class TenderRedPacketFailExecuter extends BaseExecuter {
	private String accountLogType = Constant.TENDER_RED_PACKET_FAIL;
	private String sumLogRemarkTemplate = "奖励合计：红包扣回金额${money}元。";
	@Override
