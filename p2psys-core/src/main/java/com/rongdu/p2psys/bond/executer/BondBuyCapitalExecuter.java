 ...
 * @since 2014-12-12
 */
public class BondBuyCapitalExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_BUY_CAPITAL;
	private String sumLogRemarkTemplate = "债权转让归还本金${capital}元，债权ID：[${bond.id}]。";
	...
	public void handleAccount() {
	    accountDao.modify(-super.money + super.redMoney, -super.money + super.redMoney, 0, 0, 0, super.user.getUserId());
	}
