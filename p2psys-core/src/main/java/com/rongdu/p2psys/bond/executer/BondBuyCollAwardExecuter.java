 ...
 * @since 2014-12-12
 */
public class BondBuyCollAwardExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_BUY_COLL_AWARD;
	private String sumLogRemarkTemplate = "债权转让受让人待收奖励${collAward}元，债权ID：[${bond.id}]。";
