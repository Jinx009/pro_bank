 ...
 * @since 2014-12-12
 */
public class BondBuyCollInterestExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_BUY_COLL_INTEREST;
	private String sumLogRemarkTemplate = "债权转让受让人待收利息${collInterest}元，债权ID：[${bond.id}]。";
