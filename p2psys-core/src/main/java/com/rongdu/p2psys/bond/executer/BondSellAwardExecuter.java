 ...
 * @since 2014-12-12
 */
public class BondSellAwardExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_SELL_AWARD;
	private String sumLogRemarkTemplate = "债权转让归还奖励${award}元，债权ID：[${bond.id}]。";
