 ...
 * @since 2014-12-12
 */
public class BondSellCollAwardExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_SELL_COLL_AWARD;
	private String sumLogRemarkTemplate = "债权转让扣除待收奖励${collAward}元，债权ID：[${bond.id}]。";
