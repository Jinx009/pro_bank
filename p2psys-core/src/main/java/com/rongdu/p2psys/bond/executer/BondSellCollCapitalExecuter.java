 ...
 * @since 2014-12-12
 */
public class BondSellCollCapitalExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_SELL_COLL_CAPITAL;
	private String sumLogRemarkTemplate = "债权转让扣除待收本金${collCapital}元，债权ID：[${bond.id}]。";
