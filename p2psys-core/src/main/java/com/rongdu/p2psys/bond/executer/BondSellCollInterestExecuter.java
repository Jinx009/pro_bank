 ...
 * @since 2014-12-12
 */
public class BondSellCollInterestExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_SELL_COLL_INTEREST;
	private String sumLogRemarkTemplate = "债权转让扣除待收利息${collInterest}元，债权ID：[${bond.id}]。";
