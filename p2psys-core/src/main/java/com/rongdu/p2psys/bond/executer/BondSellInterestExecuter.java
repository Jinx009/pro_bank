 ...
 * @since 2014-12-12
 */
public class BondSellInterestExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_SELL_INTEREST;
	private String sumLogRemarkTemplate = "债权转让归还利息${interest}元，债权ID：[${bond.id}]。";
