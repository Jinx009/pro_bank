 ...
 * @since 2014-12-12
 */
public class BondSellInterestManageFeeExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_SELL_INTEREST_MANAGEFEE;
	private String sumLogRemarkTemplate = "债权转让扣除归还利息管理费${money}元，债权ID：[${bond.id}]。";
