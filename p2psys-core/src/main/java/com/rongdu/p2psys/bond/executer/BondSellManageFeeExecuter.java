 ...
 * @since 2014-12-12
 */
public class BondSellManageFeeExecuter extends BaseExecuter {

	private String accountLogType = Constant.BOND_SELL_MANAGEFEE;
	private String sumLogRemarkTemplate = "成功转让债权${money}元，收取管理费${manageFee}元，债权ID：[${bond.id}]。";
