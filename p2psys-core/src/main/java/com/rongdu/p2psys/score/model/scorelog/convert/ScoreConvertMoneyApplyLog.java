...
public class ScoreConvertMoneyApplyLog extends BaseScoreConvertLog {
	...
	private String logTemplateNid = ScoreTemplateConstant.CONVERT_MONEY_APPLY;
	
	public ScoreConvertMoneyApplyLog() {
		super();
	}

	public ScoreConvertMoneyApplyLog(long userId, int score) {
