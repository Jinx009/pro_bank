 ...
 * @since 2014年4月17日
 */
public class CustomerBaseinfoAction extends BaseAction<CustomerBaseinfoModel> implements
		ModelDriven<CustomerBaseinfoModel> {
	 ...
	 * @throws Exception
	 */
	@Action(value = "/modules/customer/customerBaseinfo")
	public String customerBaseinfo() throws Exception {
	 ...
	 * @throws Exception
	 */
	@Action("/modules/customer/exportCustomerBaseinfo")
...
//		model.setOrder("desc");
		// 记录取得
		List<CustomerBaseinfoModel> list =  customerService.customerBaseinfoList(1, 5000, model).getList();

		String title = "客户基本信息表";
		
		String[] hearders = new String[] { "编号", "销售代码", "销售姓名", "姓名", "性别", "电话号码", "年龄", "证件", "银行卡号", "银行", "注册时间", "实名认证时间", "绑卡时间","账户状态", "推荐码", "可用金额" };// 表头数组
		String[] fields = new String[] { "id", "saleCode", "saleName","realName", "sex", "phone", "age", "certificate", "bankNo", "bank", "registerTime", "realNameTime", "bindCardTime", "accountState", "recommendCode", "useMoney"};// 对象属性数组
	 ...
	 * @throws Exception
	 */
	@Action(value = "/modules/customer/customerBaseinfoList")
	public void customerBaseinfoList() throws Exception {
...
//			model.setStatus(99);
//		}
		PageDataList<CustomerBaseinfoModel> pagaDataList = customerService.customerBaseinfoList(pageNumber, pageSize, model);
