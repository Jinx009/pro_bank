...
public class CFCashAction extends BaseAction<AccountCashModel> implements ModelDriven<AccountCashModel> {
	 ...
	 */
	@SuppressWarnings("unchecked")
	@Action("/cf/cash/doAllOfflineCash")
	 ...
	 * @throws Exception
	 */
	@Action("/cf/cash/checkBankCanUse")
