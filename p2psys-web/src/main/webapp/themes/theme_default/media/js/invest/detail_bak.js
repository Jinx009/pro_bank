define(function(require,exports,module){
  ...
  $.ajax({
    type:"get",
    url:"/invest/borrowDetail.html"+window.location.search+"&random="+Math.random(),
    dataType:"json",
    cache:false,
      ...
      require.async("/plugins/handlebars-v1.3.0/handlebars-v1.3.0",function(){
          ...
          require.async('common1',function(){
            ...
            $(".sub-invest-btn").click(function(){
              ...
              var invest_money = parseInt($investMoney.text());
              var  money= parseInt($money.val());
              if(invest_money > parseInt(json.account.useMoney))
              {
              ...
              {
                                  if(money < parseInt(json.borrow.lowestAccount))
                                  {
                                  ...
                                  else if(parseInt(json.borrow.mostAccount) != 0 && money > parseInt(json.borrow.mostAccount)  )
                                  {
                                  ...
                                  else if(money > 200000 && parseInt(json.borrow.mostAccount) == 0 && json.isOpenAip && json.apiCode == 2)
                                  {
                                  ...
                                  else if(money > parseInt(json.accountWait))
                                  {
              ...
              {
                                  if(money != parseInt(json.accountWait)) //可投金额小于最小投标金额——投标金额不等于可投金额
                                  {
