      ...
      require.async("/plugins/handlebars-v1.3.0/handlebars-v1.3.0",function(){
          ...
          require.async('common1',function(){
           ...
           //全投金额
             ...
             $(".all-tb").click(function(){
               var okmoney = parseFloat($(".ok-money").html().replace(/,/gm, ""));
               $("#money").val(okmoney);
             })
          ...
          $(".protocolPreview").click(function(){
            ...
            $(".sub-invest-btn").click(function(){
              ...
              var invest_money = parseFloat($investMoney.text());
              var  money= parseFloat($money.val());
              if(invest_money > parseFloat(json.account.useMoney))
              {
              ...
              //可投金额大于最小投标金额
              if(parseFloat(json.accountWait) > parseFloat(json.borrow.lowestSingleLimit))
              {
                                  if(money < parseFloat(json.borrow.lowestSingleLimit))
                                  {
                                      $form_mony_tip.removeClass("hide").html('<b class="iconfont">&#xe60f;</b>投标金额不能小于最小投标金额<a href="javascript:;" id="invest_all">'+json.borrow.lowestSingleLimit+'</a>元！');
                                      $("#invest_all").click(function(){
                                        $money.val(json.borrow.lowestSingleLimit);
                                  ...
                                  else if(money > parseFloat(json.accountWait))
                                  {
              ...
              {
                                  if(money != parseFloat(json.accountWait)) //可投金额小于最小投标金额——投标金额不等于可投金额
                                  {
