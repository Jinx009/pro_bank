	...
	var search = function(param,tpl){
		...
		$("#timeStatus a").click(function(){
			...
			if( $(".sInput").val() == undefined){
				...
				var param0 = param + "time="+$(this).data("val") + "&status=" + $("#status a.current").data("val") + "&borrowName=" + $(".sInput").val();
			}
		...
		$("#searchBtn").click(function(){
			...
			{
				var param0 = param + "status=" + $("#status a.current").data("val") + "&borrowName=" + $(".sInput").val();
			}
