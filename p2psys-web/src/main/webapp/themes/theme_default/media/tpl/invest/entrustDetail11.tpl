    ...
    <div class="mb20 bdr1-e6e6e6 bg-white">
      ...
      {{#inequality borrow/scales 100}}
		<div class="amount-form-box pt10 pl20 pr20" style="padding-left:30px;">
		  	{{#with account}}
		        <p class="amount-money">账户余额：<b class="c315A8B">￥<em class="pageUseMoney">{{useMoney}}</em></b><br/>
		        可投金额：<b class="c315A8B">￥<span class="ok-money">{{moneyFormat ../accountWait}}</span></b></p>
   ...
   <div class="invest-main-right" id="dsj-detail">
    <div class="amount-form-box pt10 pl20 pr20" style="padding-left:30px;border-left: 1px solid #e9e7e1;">
      ...
      <div class="mb20 bdr1-e6e6e6 bg-white" style="border:0;">
       ...
       <p class="amount-money">账户余额：<b class="c315A8B">￥<em class="pageUseMoney">{{moneyFormat useMoney}}</em></b><br/>
            可预约金额：<b class="c315A8B">￥<span class="ok-money">
            {{moneyFormat ../sumBidMoney}}</span></b></p>
              <div class="form-group">
                 预约金额：<input type="text" id="money" autocomplete="off" name="money" size="11" onKeyUp="value=value.replace(/[^0-9]/g,'')" placeholder="输入投标金额" style="width:170px;border:1px solid #f63"/>
                        <div class="form_group_tip form_mony_tip hide">请输入投标金额进行投标</div><i>元</i>
              </div>
             {{#equal ../../payPwd false}}
              <div class="form-group">
