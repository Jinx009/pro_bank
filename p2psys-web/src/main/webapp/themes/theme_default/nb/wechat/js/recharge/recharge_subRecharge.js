define(function(require,exports,module){
	require('jquery');
	/*$.ajax({
		url:"/nb/wechat/cash/myBank.html?random="+Math.random(),
		type:"get",
		dataType:"json",
...
//                        	+"</div></li>";
                        	...
                        	+"<img class=\"bank_icon\" src=\"/themes/theme_default/nb/wechat/img/setCard.png\">"
	...
	require.async('jquery.form',function(){
		$("#recPayBtn").click(function(){
		 ...
		 $("#payForm").ajaxSubmit({
		     type: "post",
		     url: "/nb/wechat/recharge/dollPayRecharge.html",
		     dataType: "json",
		     success: function(data){
	...
	$(".cz-fs span").on("click",function(){
		...
		if(statusVal==3){
			$("#payForm").attr("action","/nb/wechat/recharge/doOfflineRecharge.html");
		}else{
			$("#payForm").attr("action","/nb/wechat/recharge/doRecharge.html");
		}
	})
