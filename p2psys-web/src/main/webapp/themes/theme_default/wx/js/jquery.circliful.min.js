	...
	t.fn.circliful = function(i) {
		...
		return this.each(function() {
			...
			function d(e) {
				...
				"outline" == h.border ? u.lineWidth = h.width + 13 : "inline" == h.border && (u.lineWidth = h.width - 13),
				u.strokeStyle = h.fgcolor,
				u.stroke(),
				u.beginPath(),
				u.arc(x, b, w-12,0, Math.PI * 2, !1),
				u.fillStyle = h.fgcolor,
				u.fill(),
				u.beginPath(),
				u.arc(x, b, w-13,0, Math.PI * 2, !1),
				u.fillStyle = '#FFFFFF',
				u.fill(),
				// alert("p:"+p+"####"+"M:"+M);
				p > M && (M += I, requestAnimationFrame(function() {
					d(Math.min(M, p) / 100)
				},
				f)),
			...
			void 0 != t(this).data("info") && (r = t(this).data("info"), void 0 != t(this).data("type") ? (F = t(this).data("type"), "half" == F ? n(f, .9) : n(f, 1.25)) : n(f, 1.25)),
			...
			void 0 != t(this).data("type") && (F = t(this).data("type"), "half" == F && (y = 2 * Math.PI, z = 3.13, C = Math.PI, k = Math.PI / .996)),
			d(M / 100)
