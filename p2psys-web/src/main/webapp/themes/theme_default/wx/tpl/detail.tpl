 ...
 <input type="hidden" name="id" value="{{id}}"/>
	<div class="title">
		<table class="title-tab">
			...
			<tr>
				<td class="check"></td>
				<td class="tag" style="width:30%;">T+1赎回</td>
				<td class="check"></td>
	...
	<div class="row8" style="padding-bottom:10px;">
		...
		<div style="font-size:12px;line-height:22px;margin:15px 0 15% 2%;max-width: 640px;min-width: 120px;width: 96%;" id="content">{{borrowDetailContent content}}</div>
	</div>
