	...
	<div >
		<div class="circle" id="myStat" data-dimension="120" data-text="{{scales}}%"
			data-info="" data-width="15" data-fontsize="18" data-percent="{{scales}}"
			data-fgcolor="#81D8D0" data-bgcolor="#F1EFEF" data-fill="#FFFFFF"></div>
	</div>
